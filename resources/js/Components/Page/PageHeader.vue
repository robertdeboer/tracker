...
<template>
    <div class="bg-app-blue border-b border-gray-100">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <p
                            class="inline-flex items-center px-1 pt-1 text-4xl leading-5 text-white"
                        >
                            {{ title }}
                        </p>
                    </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    ...
                    <!-- Settings Dropdown -->
                    <div v-if="$page.props.in_sandbox" class="ml-3 relative">
